...
- ✅ Explicit agent-memory/ usage criteria
...
├── palace/wings/agent-memory/rooms/
...
- ✅ agent-memory/ usage criteria (explicit state/knowledge/palace rules)
...
- ✅ Knowledge preserved (agent-memory/)
