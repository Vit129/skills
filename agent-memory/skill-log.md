...
| 2026-05-06 | ai-dlc/core/aidlc | Agent skips dialog on short commands ("PBI-002") and dumps all artifacts without pause between phases | Added 2 gotchas: "dialog skipped on short commands" + "bulk artifact dump" with explicit fix steps | applied |
