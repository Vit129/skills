...
| 2026-06-03 | agy | Codex companion invoked 3 times but has no Claude Code SKILL.md entry; routing/delegation unclear | Create `skills/agy/SKILL.md` with companion definition, delegation scope, and usage patterns (no change to Codex agy-companion itself) | proposed |
| 2026-06-03 | research-idea | External research pattern invoked 4 times; no formalized Claude Code skill or documented approach | Create `skills/research-idea/SKILL.md` with research methodology, scope (news/ETF/portfolio), integration with finance lane | proposed |
