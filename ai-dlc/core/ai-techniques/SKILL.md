...
> **Note:** Step-Back Prompting is now embedded in `analysis-skills/references/context.md` (Phase 1).
> Resources Discovery is now embedded in `analysis-skills/references/discovery-domain.md` (Phases 1-3).
