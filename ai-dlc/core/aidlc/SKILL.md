...
- AI reasoning → `ai-techniques` (CoT for linear, LATS for compare, AoT for complex branching, Step-Back for big picture, Discovery for reuse scan)
...
## Project Specifics
- **My Investment Port** — Domain knowledge and dev context. (Read `references/investment-port.md`)
