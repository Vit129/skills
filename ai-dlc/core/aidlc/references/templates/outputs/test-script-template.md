...
### 8. UI Test Template with Screenshots
```typescript
...
#### 1. Accessibility ID (Highest Priority - Most Stable)
```robot
...
#### 4. XPath (Fourth Priority - Use When Necessary)
```robot
