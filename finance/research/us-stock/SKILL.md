...
name: us-stock
description: >
  วิเคราะห์หุ้น US ในพอร์ต My Investment Port รวมถึง P&L, FX impact และ sector weight.
  Trigger เมื่อผู้ใช้พูดว่า "หุ้น US", "วิเคราะห์หุ้น", "ดูพอร์ต", "P&L",
  "กำไรขาดทุน", "FX", "USD/THB", "sector", หรือถามเกี่ยวกับหุ้นตัวใดตัวหนึ่งใน portfolio.
  ใช้ skill นี้ทุกครั้งที่ผู้ใช้ต้องการข้อมูลเกี่ยวกับ US holdings.
---
