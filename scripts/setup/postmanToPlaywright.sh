...
POSTMAN_SRC="$SKILLS_ROOT/tooling/postman-to-playwright/scripts"
...
SKILL_IN_PROJECT="$ROOT_DIR/postman-to-playwright"
if [ -d "$SKILL_IN_PROJECT" ]; then
    echo "ℹ️  postman-to-playwright skill already exists at:"
    echo "   $SKILL_IN_PROJECT"
    echo ""
...
echo "📦 ติดตั้ง postman-to-playwright ที่: $DEST_DIR"
