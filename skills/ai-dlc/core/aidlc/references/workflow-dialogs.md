...
| **Phase 2.1** (QA Task Design) | context-gatherer | `"context-gatherer"` | Before designing tasks — scan existing test patterns | `ai-dlc/knowledge/automation/` + existing test root |
