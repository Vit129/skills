...
|-----------|------|---------|
| Design references (brand guidelines, mood boards) | Design input | Inform aesthetic direction |
| `references/*.md` (one per concern) | Skill reference | Typography, color, spatial, motion, interaction |
| Accessibility standards (WCAG 2.1 AA) | Compliance | Ensure contrast, motion, focus requirements met |
...
|------|--------------|------|
| After design proposal | Single select (present 3-5 aesthetic directions) | Before committing to visual direction |
...
1. **Record good example:** Save approved output to `knowledge/lessons/design/{pattern}.md`
