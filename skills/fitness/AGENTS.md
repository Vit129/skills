...
For personal/current chat: load `personal/personal.md` first, then add the relevant reference.
...
2. `personal/personal.md` — when user-specific or current tracking is involved
