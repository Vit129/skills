...
- Web/API → `rules/playwright-rules/` (pw-coding-standards.md + web-ui.md or api.md)
- Mobile → `rules/robotframework-rules/` (rf-coding-standards.md + android.md or ios.md)
