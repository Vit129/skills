...
| After requirements captured (GLOSSARY.md), before `/plan`, complex feature | `references/amigos.md` |
...
> **Note:** `doc.md` uses `references/domain-modeling.md` for GLOSSARY.md and decision-recording rules.
