...
| After requirements captured (LANGUAGE.md), before `/plan`, complex feature | `references/amigos.md` |
...
> **Note:** `doc.md` uses `references/domain-modeling.md` for LANGUAGE.md and decision-recording rules.
