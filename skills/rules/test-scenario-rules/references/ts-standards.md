...
- Run: `az boards work-item show --id {PBI_ID} --query "fields.\"System.AssignedTo\".uniqueName" --output tsv`
- Store result → use for col 20 of PBI row in CSV
- If fetch fails → ask user: "PBI Assigned To email คืออะไรครับ?"
