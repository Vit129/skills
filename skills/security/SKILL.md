...
| Signal | Mode | Load |
|--------|------|------|
| "secure coding", "security hardening", Phase 3.1 / implementation | **Dev** | `references/dev.md` |
| "security scenarios", "security test", Pre-flight Q5 = Yes, Phase 2.2/2.4 | **QA** | `references/qa.md` |
