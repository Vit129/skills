...
|------|--------------|------|
| After each role's output (PO/Dev/QA) | Open field (feedback/refine) | After synthesis of all 3 roles |
| After synthesis (approve/refine) | Single select | Before proceeding to Phase 2 |
| Scale override | Single select (quick/normal/deep) | If auto-detected scale doesn't match user intent |
